export const testFileUrls = [
  "/test_files/tiff_images/not-available.tiff",
  "/test_files/tiff_images/tiff-example-file-download-1024x1024.tiff",
  "/test_files/tiff_images/file_example_TIFF_10MB.tiff",
  "/test_files/pdf_files/invoicesample.pdf",
  "/test_files/pdf_files/invoicesample2.pdf",
  "/test_files/pdf_files/sample.pdf",
  "/test_files/pdf_files/not-available.pdf",
  "/test_files/images/forest.png",
  "/test_files/images/montañas.webp",
  "/test_files/images/arboles.XXXX?w=996",
  "/test_files/images/sample_1920×1280.jpeg",
  "/test_files/images/sample_1920×1280.tiff",
  "/test_files/images/gallardo.svg",
  "/test_files/images/Example.jpg",
  "/test_files/images/480-360-sample.jpg",
];

export const imagePlaceholder = `data:image/svg+xml,
<svg width="800" height="800" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect width="120" height="120" fill="%23EFF1F3"/>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M33.2503 38.4816C33.2603 37.0472 34.4199 35.8864 35.8543 35.875H83.1463C84.5848 35.875 85.7503 37.0431 85.7503 38.4816V80.5184C85.7403 81.9528 84.5807 83.1136 83.1463 83.125H35.8543C34.4158 83.1236 33.2503 81.957 33.2503 80.5184V38.4816ZM80.5006 41.1251H38.5006V77.8751L62.8921 53.4783C63.9172 52.4536 65.5788 52.4536 66.6039 53.4783L80.5006 67.4013V41.1251ZM43.75 51.6249C43.75 54.5244 46.1005 56.8749 49 56.8749C51.8995 56.8749 54.25 54.5244 54.25 51.6249C54.25 48.7254 51.8995 46.3749 49 46.3749C46.1005 46.3749 43.75 48.7254 43.75 51.6249Z" fill="%23687787"/>
</svg>
`;

export const noValidImage = `data:image/svg+xml,
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="300" height="300" viewBox="0 0 300 300" xml:space="preserve">
   <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(50 0) scale(2.3 2.3)" >
   ...
   <text x="90" y="240" fill="red" style="font: bold 26px sans-serif;">PREVIEW</text>
   <text x="46" y="270" fill="red" style="font: bold 26px sans-serif;">NOT AVAILABLE</text>
</svg>
`;
